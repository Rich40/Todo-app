  ...
  final List<Map<String, dynamic>> data = [
    {
      ...
      'description':
          'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Etiam tincidunt a nisi eu pharetra. Morbi sed sem sodales, posuere odio vel, tempor leo. Mauris eget suscipit erat, nec imperdiet justo. Donec sagittis magna eget suscipit fermentum. Fusce mollis lacinia risus. Nunc elementum vel odio nec sagittis. Donec a consectetur justo. Pellentesque suscipit tortor egestas ex viverra ultrices. Phasellus nec cursus sapien. Phasellus et lectus tristique, maximus quam sit amet, ultricies libero. Nulla vitae arcu quis ipsum vulputate luctus sit amet nec justo. Curabitur a vestibulum mauris. Donec et lacus scelerisque, commodo leo nec, porttitor nisl.',
      'date_time': 'Yesterday',
      'status': true,
    },
    {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: ListView.separated(
          ...
          //if selectedItem == 'todo' use _unCompletedData.length else use _completedData.length
